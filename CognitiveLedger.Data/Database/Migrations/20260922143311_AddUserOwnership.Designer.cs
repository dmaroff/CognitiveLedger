...
namespace CognitiveLedger.Data.Database.Migrations
{
    ...
    [Migration("20260922143311_AddUserOwnership")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CognitiveLedger.Data.Models.CreditCard.CreditCardStatement", b =>
                {
                    ...
                    b.HasIndex("UserId", "SourceDocumentSha256")
                        .IsUnique()
                        .HasFilter("source_document_sha256 IS NOT NULL");

                    b.HasIndex("UserId", "Issuer", "AccountName", "StatementPeriodEnd");
            ...
            modelBuilder.Entity("CognitiveLedger.Data.Models.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CognitiveLedger.Data.Models.CreditCard.CreditCardStatement", b =>
                {
                    ...
                    b.HasOne("CognitiveLedger.Data.Models.User", "User")
                        .WithMany("Statements")
